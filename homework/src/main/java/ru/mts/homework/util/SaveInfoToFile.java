...
public class SaveInfoToFile {
    private Path dataPath = Paths.get("homework","src", "main", "java", "ru", "mts", "homework", "resources", "animals", "logData.txt");
    private Path secPath = Paths.get("homework","src", "main", "java", "ru", "mts", "homework", "resources", "secretStore", "secretInformation.txt");
    private Path jsnPath = Paths.get("homework","src", "main", "java", "ru", "mts", "homework", "resources", "results", "findOlderAnimals.json");
